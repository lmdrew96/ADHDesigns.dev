    ...
    <footer id="contact" className="py-16 px-4 sm:px-6 lg:px-8 bg-adhd-purple/60 backdrop-blur-xl text-popover-foreground relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="font-[family-name:var(--font-display)] text-3xl sm:text-4xl md:text-5xl text-adhd-teal font-bold mb-4">
          ...
          <Button
            size="lg"
            className="bg-adhd-sage text-adhd-dark hover:bg-adhd-sage/90 rounded-full px-8 py-6 text-lg font-bold"
            asChild
          >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-left">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full flex items-center justify-center bg-adhd-sage overflow-hidden">
